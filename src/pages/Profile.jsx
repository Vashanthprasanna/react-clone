...
function Profile() {
  ...
  return (
    <Box sx={{ mx: 3, my: 4 }}>
      ...
      <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', width: '82vw', position: 'sticky', top: 20, zIndex: 1, borderRadius: 2, px: 1, backdropFilter: 'saturate(200%) blur(200px)', backgroundColor: 'rgba(255, 255, 255, 0.8)', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)' }}>
      ...
      <Box sx={{
        ...
        height: 300, backgroundSize: 'cover',     // fills the box
        backgroundPosition: '50% center',  // centers the image
        backgroundRepeat: 'no-repeat', borderRadius: 3
      }}>

        <Box sx={{ border: '1px solid grey', borderRadius: 2, p: 2, backgroundColor: 'grey', width: '96%', alignItems: 'center', zIndex: 1, top: 250, position: 'relative', mx: 3 }}>
          ...
          <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', mt: 5, px: 2, py: 2, backgroundColor: 'white' }}>
            ...
            <Box sx={{ textAlign: 'left', width: '32%', height: 355 }}>
            ...
            <Box sx={{ textAlign: 'left', width: '100%', my: 3, mt: 8 }}>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <Box sx={{ width: '20%', backgroundColor: 'white', mt: 3 }}>
                  <img src="./proj_1.jpg" alt="Project 1" width={241} height={137} />
                ...
                <Box sx={{ width: '20%', backgroundColor: 'white', mt: 3 }}>
                  <img src="./proj_2.jpg" alt="Project 2" width={241} height={137} />
                ...
                <Box sx={{ width: '20%', backgroundColor: 'white', mt: 3 }}>
                  <img src="./proj_3.jpg" alt="Project 3" width={241} height={137} />
                ...
                <Box sx={{ width: '20%', backgroundColor: 'white', mt: 3 }}>
                  <img src="./proj_4.jpeg" alt="Project 4" width={241} height={137} />
